...
With these distributions, a non-parametric method was selected, Using 10-fold cross-validation on the 14,718 observations in the training set, and the KNN method. To find the best value for K, tuneLength of 10 was set. Also, all variables were standardized to avoid problems from scaling differences.
